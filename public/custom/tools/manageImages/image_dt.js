...
var KTDatatablesServerSide = (function () {
    ...
    var initDatatable = function () {
        var imageTableRoute = $("#image_dt").data("table-route");
        dt = $("#image_dt").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            order: [[0, "desc"]],
            ...
            columns: [
                ...
                { data: "image_name" },
                {
                    data: "image_path", // Assuming server returns image_url
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <div class="menu-item px-3">
                            <a href="#" id="delete_image" data-id="` +
                            data.id +
                            `" data-imagename="` +
                            data.image_name +
    ...
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector("#imageSearch");
...
KTUtil.onDOMContentLoaded(function () {
    ...
    jQuery(document).off("change", "#imageSearch");
    jQuery(document).on("change", "#imageSearch", function (e) {
        if ($(this).val().length == 0) {
            $("#image_dt").DataTable().search($("#imageSearch").val()).draw();
        }
    });
