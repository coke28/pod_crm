            ...
            <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                ...
                <div class="col-lg-6">
                    <div class="general-contact-info">
                        ...
                        <p>T 514 353 6060</p>
                        <hr />
                        <h5>SILVANA ARRIGO</h5>
                        <p>sarrigo@podcentres.com</p>
                        <p>Vice-Président en Location / Vice-President Leasing</p>
                        <p>Développements Immobiliers - POD - Real Estate Development Inc.</p>
                        <p>9100 Pascal Gagnon, suite 200 /// Montréal ( Québec) /// H1P 2X4</p>
                        <p>T 514 353 6060 #102</p>
                    </div>
                </div>
            </div>
...
<!-- Add some styling to make the text appear cleaner -->
<style>
    .general-contact-info h5 {
        margin: 0 0 10px 0;
        color: #333;
    }
