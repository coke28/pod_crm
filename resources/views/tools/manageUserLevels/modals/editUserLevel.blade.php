...
<div class="modal fade" id="editUserLevel" data-bs-backdrop="static" tabindex="-1" role="dialog"
    aria-labelledby="editUserLevel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content" id="userLevelModalContent">
            ...
            <div class="modal-body">
                ...
                <form class="form" id="edit_user_level_form">
                    ...
                    <div class="fv-row mb-6 ms-10 n1_crm">
                        ...
                        <div class="fv-row mb-6 ms-10 n2_dashboard">
                            {{-- <div class="fv-row mb-6">
                                <label class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input n1_crm n2_dashboard" type="checkbox"
                                        name="n3_globalsearch" value="1" checked />
                                    <span class="form-check-label fw-bold text-gray-700 fs-6">Global Search
                                    </span>
                                </label>
                            </div> --}}
                        </div>
                        ...
                        <div class="fv-row mb-6 ms-10 n1_tools">
                            ...
                            <div class="fv-row mb-6">
                                <label class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input n1_tools" type="checkbox" name="n2_user_roles"
                                        value="1" checked />
                        ...
                        <div class="error-box" style="display: none;">
                            ...
                            <div id="name_error_edit" class="error-message"></div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light-danger font-weight-bold"
                            data-bs-dismiss="modal">Close</button>
                        <button type="submit" id="editUserLevelSubmitBtn" class="btn btn-primary font-weight-bold">Edit
                            User
                            Level</button>
                    </div>
                </form>
