        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form" id="add_category_form">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-10 fv-row">
                            <textarea name="category_description" class="form-control form-control-lg form-control-solid"
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="addCategorySubmitBtn" class="btn btn-primary font-weight-bold"
                    data-category-add-route="{{ route('category.add') }}">Add Category</button>
            </div>
            </form>
        </div>
    </div>
